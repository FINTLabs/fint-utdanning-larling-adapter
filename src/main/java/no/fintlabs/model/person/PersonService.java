...
public class PersonService {
    ...
    private PersonResource createPersonResource(Contract contract) {
        ...
        personResource.addLarling(Link.with(LarlingResource.class, "utdanning/larling/larling/systemid", contract.getElev().getSystemId()));
        personResource.addSelf(Link.with(Person.class, "utdanning/larling/person/systemid", contract.getElev().getFodselsNummer()));
